...
class ItemForm(Form):
    ...
    picture_url = StringField('Picture', validators=[URL(), Optional(), Length(max=256)])
    category = QuerySelectField('Category', query_factory=Category.query.all, allow_blank=False)
